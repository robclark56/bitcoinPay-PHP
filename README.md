...
In this project we include a very simple dummy eCommerce checkout page that serves an an example of how to deploy _lightningPay_. 
## Prepare LND ##
...
* Edit the _CHANGE ME_ section of `lightningPay.php`. This is where you enter the HEX version of your _invoice.macaroon_.
